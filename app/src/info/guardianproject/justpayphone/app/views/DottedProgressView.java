...
import info.guardianproject.justpayphone.models.ViewPagerIndicator;
...
public class DottedProgressView extends View implements ViewPagerIndicator
{
	...
	private void init(AttributeSet attrs)
	{
		...
		if (attrs != null)
		{
			...
			mDistance = a.getDimensionPixelOffset(R.styleable.DottedProgressView_dot_distance, 21);
			mRadius = a.getDimensionPixelSize(R.styleable.DottedProgressView_dot_radius, 5);
